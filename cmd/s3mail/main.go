...
import (
	...
	"github.com/ohartwig/s3mail/keyring"
	"github.com/ohartwig/s3mail/s3fake"
	"github.com/ohartwig/s3mail/store"
	"github.com/ohartwig/s3mail/web"
	"github.com/ohartwig/s3mail/wizard"
)

// version is set at build time: -ldflags "-X main.version=v0.2.0". A binary
// from `go install …@v1.4.0` has no ldflags but knows its module version,
